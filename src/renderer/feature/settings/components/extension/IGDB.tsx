...
export const SettingExtensionIGDB = () => {
  ...
  return (
    <>
      <Section>
        <Section.Title title={t("extension.igdb.sectionTitles.enable", { ns: LOCALE_NAMESPACE.SETTINGS })} />
        <Section.Content>
      ...
      {isEnabled && (
        <Section>
          <Section.Title title={t("extension.igdb.sectionTitles.authentication", { ns: LOCALE_NAMESPACE.SETTINGS })} />
          <Section.Content>
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-8">
                <InputText
