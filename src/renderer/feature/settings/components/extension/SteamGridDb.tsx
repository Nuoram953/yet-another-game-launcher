...
export const SettingExtensionSteamGridDb = () => {
  ...
  return (
    <>
      <Section>
        <Section.Title title={t("extension.steamGridDb.sectionTitles.enable", { ns: LOCALE_NAMESPACE.SETTINGS })} />
        <Section.Content>
      ...
      {isEnabled && (
        <Section>
          <Section.Title
            title={t("extension.steamGridDb.sectionTitles.authentication", { ns: LOCALE_NAMESPACE.SETTINGS })}
          />
          <Section.Content>
            <div className="flex flex-col gap-8">
              <InputText
