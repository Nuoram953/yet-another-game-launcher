  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={() => removeFn(id)}
          className="text-slate-400 opacity-0 transition-opacity hover:text-design-error group-hover:opacity-100 dark:hover:text-red-400"
          type="button"
        >
          <X size={18} />
        </button>
    ...
    <div className="flex h-screen flex-col overflow-hidden bg-slate-100 dark:bg-slate-900">
      <header className="bg-white px-6 py-4 shadow-md dark:bg-slate-800">
        <div className="mx-auto max-w-7xl">
          <h1 className="text-2xl font-bold text-slate-800 dark:text-design-normal">Top 10 Games Ranking</h1>
          ...
          <div className="flex flex-col gap-6 overflow-y-auto pr-2">
            ...
            <div className="flex flex-col">
              <div className="mb-4 flex items-center justify-between">
                <h2 className="flex items-center gap-2 text-xl font-semibold text-slate-800 dark:text-design-normal">
                  <ListOrdered size={20} />
                  Your Top 10 Games
                </h2>
