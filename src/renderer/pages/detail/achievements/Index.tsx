    ...
    switch (sortBy) {
      ...
      case "date":
        if (a.isUnlocked && b.isUnlocked) {
          const aUnlockedAt = a.unlockedAt
            ? new Date(Number(a.unlockedAt)).getTime()
            : 0;
          const bUnlockedAt = b.unlockedAt
            ? new Date(Number(b.unlockedAt)).getTime()
            : 0;
