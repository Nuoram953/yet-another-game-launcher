...
const GameDetailsContent: React.FC = () => {
        ...
        <div className="space-y-1">
          {filteredSections.map((section, index) => (
            ...
            >
              ...
              <span className={activeSection === section.id ? "font-medium text-design-normal" : "text-gray-300"}>
                {section.label}
              </span>
  ...
  return (
    <div className="flex h-screen flex-col bg-gradient-to-br from-gray-900 to-gray-800 text-design-normal">
      <Background>
          ...
          <div className="relative p-4 backdrop-blur-lg dark:bg-slate-800">
            ...
            {!collapsed && (
              <div className="mt-3 text-center">
                <h2 className="text-sm font-bold text-design-normal">{selectedGame?.name}</h2>
              </div>
            )}
          </div>
