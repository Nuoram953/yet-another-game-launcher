...
export const Overview = () => {
  ...
  const validScores = [selectedGame.scoreCritic, selectedGame.scoreCommunity, selectedGame.review?.score].filter(
  ...
  const overallScore =
    validScores.length > 0
      ...
      : Math.round((selectedGame.scoreCritic + selectedGame.scoreCommunity) / 2);
  ...
  const scores = [
    {
      ...
      value: selectedGame.scoreCritic,
      icon: Award,
    },
    {
      id: "community",
      ...
      value: selectedGame.scoreCommunity,
      icon: Users,
    },
    {
      id: "user",
      ...
      value: selectedGame.review?.score,
      icon: User,
    },
  ];
