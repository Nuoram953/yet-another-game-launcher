  ...
  return (
    <div className="relative mx-auto w-full">
      <div className="relative h-[24rem] overflow-hidden">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 p-2 text-design-normal transition-colors hover:bg-black/70"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 p-2 text-design-normal transition-colors hover:bg-black/70"
