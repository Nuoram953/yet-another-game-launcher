...
INSERT INTO "new_Game" ("createdAt", "externalId", "gameStatusId", "id", "isFavorite", "isInstalled", "lastTimePlayed", "location", "name", "scoreCommunity", "scoreCritic", "scoreUser", "size", "storefrontId", "summary", "timePlayed", "timePlayedDisconnected", "timePlayedLinux", "timePlayedMac", "timePlayedSteamdeck", "timePlayedWindows", "updatedAt") SELECT "createdAt", "externalId", "gameStatusId", "id", "isFavorite", "isInstalled", "lastTimePlayed", "location", "name", "scoreCommunity", "scoreCritic", "scoreUser", "size", "storefrontId", "summary", "timePlayed", "timePlayedDisconnected", "timePlayedLinux", "timePlayedMac", "timePlayedSteamdeck", "timePlayedWindows", "updatedAt" FROM "Game";
DROP TABLE "Game";
